...
object DatabaseSeeder {
    ...
    fun checklistTasks(date: String): List<ChecklistTaskEntity> = listOf(
        ...
        ChecklistTaskEntity("CHK_${date}_2", PATIENT_ID, "Morning medications (Furosemide, Carvedilol, Spironolactone)", "MORNING", "medication", false, null, date, templateId = "T_MED_AM", scheduledTime = "00:30"),
